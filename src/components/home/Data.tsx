...
<div className="home__data">
    <h1 className="home__title">Samuel Santana
        <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
    ...
    <p className="home__description">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ullam sapiente accusamus, consectetur unde doloribus, soluta harum minus atque iusto eligendi dolorem error nam. Itaque accusamus, magnam esse quidem aperiam in!</p>
